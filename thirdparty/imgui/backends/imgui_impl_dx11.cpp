...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    // Create texture sampler
    {
        ...
        desc.MinLOD = 0.0f;
        // [Solace] Was 0, which pins sampling to LOD 0 and disables mipmaps. The
        // font atlas has a single level so it is unaffected, but user textures
        // drawn smaller than their source (the DriftWall's tiles) alias badly
        // without a mip chain.
