...
IMGUI_API float         ImFontGetKerning(ImFont* font, float size, unsigned int c_prev, unsigned int c); // [Solace]
...
struct ImGuiContext
{
    ...
    ImFontGlyph*            InputTextPasswordGlyph;             // [Solace] Glyph temporarily adjusted to a readable mask cell.
    ImFontGlyph             InputTextPasswordGlyphBackup;       // [Solace] Restored by PopPasswordFont().
